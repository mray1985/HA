...
// Constants: Rev. Proc. 2023-34, Section 3.01, Table 1 — Taxable income brackets
// ──────────────────────────────────────────────────
...
// Constants: Rev. Proc. 2023-34, Section 3.02, Table 5 — Standard deduction amounts
// ──────────────────────────────────────────────────

export const STANDARD_DEDUCTION_2025: Record<FilingStatus, number> = {
  [FilingStatus.Single]: 14600,                    // Rev. Proc. 2023-34 §3.02 — $14,600
  [FilingStatus.MarriedFilingJointly]: 29200,      // Rev. Proc. 2023-34 §3.02 — $29,200
  [FilingStatus.MarriedFilingSeparately]: 14600,   // Rev. Proc. 2023-34 §3.02 — $14,600
  [FilingStatus.HeadOfHousehold]: 21900,           // Rev. Proc. 2023-34 §3.02 — $21,900
  [FilingStatus.QualifyingSurvivingSpouse]: 29200, // Rev. Proc. 2023-34 §3.02 — $29,200 (same as MFJ)
};

// Additional standard deduction for age 65+ and/or blind
// Authority: IRC §63(f) — Additional amounts for aged/blind
// Constants: Rev. Proc. 2023-34, Section 3.02
export const ADDITIONAL_STANDARD_DEDUCTION = {
  UNMARRIED: 1950,   // Single, HoH — Rev. Proc. 2023-34 §3.02
  MARRIED: 1550,     // MFJ, MFS — Rev. Proc. 2023-34 §3.02
};
...
export const DEPENDENT_STANDARD_DEDUCTION = {
  MIN_AMOUNT: 1300,         // Minimum standard deduction for dependents — Rev. Proc. 2023-34 §3.02
  EARNED_INCOME_PLUS: 450,  // Greater of MIN_AMOUNT or (earned income + 450) — Rev. Proc. 2023-34 §3.02
};
...
// Constants: Rev. Proc. 2023-34 §3 — SS wage base; SSA announcement — $168,600 for 2024
// ──────────────────────────────────────────────────
...
export const SE_TAX = {
  ...
  SS_WAGE_BASE: 168600,           // SSA COLA announcement, Oct 2023 — 2024 SS wage base
  ...
  FARM_OPTIONAL_METHOD_MAX: 7020,                // Schedule SE Part II §A, Line 14 — max net earnings under farm optional method (2024)
};

// ──────────────────────────────────────────────────
// Qualified Business Income (QBI) Deduction
// Authority: IRC §199A — Qualified business income deduction (20%); TCJA §11011
// Constants: Rev. Proc. 2023-34, Section 3.29 — Threshold amounts
// ──────────────────────────────────────────────────
...
export const HOME_OFFICE_DEPRECIATION = {
  ...
  // First-year depreciation percentage by month placed in service (2024)
...
// Constants: IRS Notice 2023-80 — Standard mileage rate for 2024
// ──────────────────────────────────────────────────

export const VEHICLE = {
  STANDARD_MILEAGE_RATE: 0.67,    // IRS Notice 2023-80 — $0.67/mile for 2024
};

// ──────────────────────────────────────────────────
// Vehicle Depreciation (MACRS 5-Year / Section 280F)
// Authority: IRC §168 — MACRS; IRC §280F — Luxury vehicle limits
//           IRC §168(k) — Bonus depreciation (60% for 2024 under TCJA phase-down)
// Constants: Rev. Proc. 2023-34 — Section 280F dollar amounts for 2024
// ──────────────────────────────────────────────────

export const VEHICLE_DEPRECIATION = {
  // Section 280F limits WITH bonus depreciation (Rev. Proc. 2023-34)
  SECTION_280F_LIMITS_BONUS: {
    year1: 20200,     // First year with bonus depreciation
    year2: 19500,     // Second year
    year3: 11700,     // Third year
    year4Plus: 7160,  // Fourth and subsequent years
  } as Record<string, number>,

  // Section 280F limits WITHOUT bonus depreciation
  SECTION_280F_LIMITS_NO_BONUS: {
    year1: 12400,     // First year without bonus
    year2: 19500,
    year3: 11700,
    year4Plus: 7160,
  } as Record<string, number>,
  ...
  SUV_SECTION_179_LIMIT: 28900,

  // Bonus depreciation rate — TCJA phase-down: 60% for 2024
...
//           IRC §168(k) — Bonus depreciation (60% for 2024 under TCJA phase-down)
// Constants: Rev. Proc. 2023-34, Section 3 — Section 179 dollar limits for 2024
//           IRS Pub 946, Table A-1 — GDS 200% DB, half-year convention
// ──────────────────────────────────────────────────

export const SECTION_179 = {
  /** Maximum Section 179 deduction for 2024. Rev. Proc. 2023-34. */
  MAX_DEDUCTION: 1220000,
  /** Total cost threshold — deduction reduced dollar-for-dollar above this amount. Rev. Proc. 2023-34. */
...
/** Bonus depreciation rate for 2024 (60% under TCJA phase-down). IRC §168(k). */
export const BONUS_DEPRECIATION_RATE_2025 = 0.60;

/** Tax year for MACRS year-index computation. */
export const DEPRECIATION_TAX_YEAR = 2024;
...
//           TCJA §11042 — SALT limitation ($10,000 cap); TCJA §11043 — Mortgage limit
// Note: Pre-OBBBA TCJA rules apply for 2024
// ──────────────────────────────────────────────────

export const SCHEDULE_A = {
  SALT_CAP: 10000,                // TCJA §11042 — $10,000 SALT cap (pre-OBBBA)
  SALT_CAP_MFS: 5000,             // TCJA §11042 — $5,000 if MFS (pre-OBBBA)
  SALT_PHASE_DOWN_THRESHOLD: Infinity,  // N/A for 2024 — OBBBA starts 2025
  SALT_PHASE_DOWN_THRESHOLD_MFS: Infinity,
  SALT_PHASE_DOWN_RATE: 0,        // N/A for 2024
  SALT_CAP_FLOOR: 10000,          // TCJA — $10,000 floor (pre-OBBBA)
  SALT_CAP_FLOOR_MFS: 5000,       // TCJA — $5,000 floor if MFS (pre-OBBBA)
...
// Constants: Rev. Proc. 2023-34, Section 3.23 — CTC refundable max ($1,700)
// ──────────────────────────────────────────────────

export const CHILD_TAX_CREDIT = {
  PER_CHILD: 2000,                // IRC §24(a) — $2,000 per qualifying child (under 17)
  ...
  REFUNDABLE_MAX: 1700,           // Rev. Proc. 2023-34 — Max ACTC per child for 2024
};

// ──────────────────────────────────────────────────
// Education Credits
// Authority: IRC §25A(b) — AOTC; IRC §25A(c) — LLC; IRC §25A(i) — AOTC modifications
// Constants: Rev. Proc. 2023-34, Section 3.24-3.25 — Phase-out thresholds
// ──────────────────────────────────────────────────
...
export const EDUCATION_CREDITS = {
  ...
  LLC_PHASE_OUT_SINGLE: 80000,              // Rev. Proc. 2023-34 §3.25 — $80k (Single)
  LLC_PHASE_OUT_RANGE_SINGLE: 10000,        // Rev. Proc. 2023-34 §3.25 — $10k range
  LLC_PHASE_OUT_MFJ: 160000,                // Rev. Proc. 2023-34 §3.25 — $160k (MFJ)
  LLC_PHASE_OUT_RANGE_MFJ: 20000,           // Rev. Proc. 2023-34 §3.25 — $20k range
};
...
// Constants: Rev. Proc. 2023-34 — HSA contribution limits for 2024
// ──────────────────────────────────────────────────

export const HSA = {
  INDIVIDUAL_LIMIT: 4150,          // Rev. Proc. 2023-34 — Self-only coverage limit
  FAMILY_LIMIT: 8300,              // Rev. Proc. 2023-34 — Family coverage limit
  CATCH_UP_55_PLUS: 1000,          // IRC §223(b)(3)(B) — $1,000 catch-up (not indexed)
};

// ──────────────────────────────────────────────────
// Archer MSA Contribution Limits (2024)
// Authority: IRC §220(b) — Contribution limits; IRC §220(d) — HDHP definition
// Constants: Rev. Proc. 2023-34 — Archer MSA HDHP thresholds
// ──────────────────────────────────────────────────
...
export const ARCHER_MSA = {
  ...
  SELF_ONLY_DEDUCTIBLE_MIN: 2800,  // Rev. Proc. 2023-34 — Minimum annual deductible
  SELF_ONLY_DEDUCTIBLE_MAX: 4150,  // Rev. Proc. 2023-34 — Maximum annual deductible
  SELF_ONLY_OOP_MAX: 5550,         // Rev. Proc. 2023-34 — Maximum out-of-pocket
  // HDHP deductible range — family
  FAMILY_DEDUCTIBLE_MIN: 5550,     // Rev. Proc. 2023-34 — Minimum annual deductible
  FAMILY_DEDUCTIBLE_MAX: 8300,     // Rev. Proc. 2023-34 — Maximum annual deductible
  FAMILY_OOP_MAX: 10100,           // Rev. Proc. 2023-34 — Maximum out-of-pocket
...
// Constants: Rev. Proc. 2023-34, Section 3.20 — Phase-out thresholds
// ──────────────────────────────────────────────────

export const STUDENT_LOAN_INTEREST = {
  MAX_DEDUCTION: 2500,             // IRC §221(b)(1) — $2,500 max deduction
  PHASE_OUT_SINGLE: 80000,        // Rev. Proc. 2023-34 — Single phase-out start ($80k)
  PHASE_OUT_RANGE_SINGLE: 15000,  // Rev. Proc. 2023-34 — $15k range ($80k-$95k)
  PHASE_OUT_MFJ: 165000,          // Rev. Proc. 2023-34 — MFJ phase-out start ($165k)
  PHASE_OUT_RANGE_MFJ: 30000,     // Rev. Proc. 2023-34 — $30k range ($165k-$195k)
};

// ──────────────────────────────────────────────────
// IRA Contribution Limits (2024)
// Authority: IRC §219(b)(5) — Contribution limits; IRC §219(g) — Deduction phase-outs
// Constants: Rev. Proc. 2023-34, Section 3.08-3.10 — IRA limits and phase-outs
// ──────────────────────────────────────────────────

export const IRA = {
  MAX_CONTRIBUTION: 7000,          // Rev. Proc. 2023-34 §3.08 — IRA contribution limit
  ...
  DEDUCTION_PHASE_OUT_SINGLE: 77000,                  // Rev. Proc. 2023-34 §3.09(1)
  DEDUCTION_PHASE_OUT_RANGE_SINGLE: 10000,             // Rev. Proc. 2023-34 §3.09(1) — $10k range
  DEDUCTION_PHASE_OUT_MFJ: 123000,                    // Rev. Proc. 2023-34 §3.09(2)
  DEDUCTION_PHASE_OUT_RANGE_MFJ: 20000,               // Rev. Proc. 2023-34 §3.09(2) — $20k range
  // MFJ where taxpayer is NOT covered but spouse IS covered by employer plan
  DEDUCTION_PHASE_OUT_MFJ_SPOUSE_COVERED: 230000,     // Rev. Proc. 2023-34 §3.09(3)
  DEDUCTION_PHASE_OUT_RANGE_MFJ_SPOUSE_COVERED: 10000, // Rev. Proc. 2023-34 §3.09(3) — $10k range
...
export const CAPITAL_GAINS_RATES = {
  ...
  THRESHOLD_0: {
    ...
    [FilingStatus.MarriedFilingJointly]: 94050,      // Rev. Proc. 2023-34 §3.12
    [FilingStatus.MarriedFilingSeparately]: 47025,   // Rev. Proc. 2023-34 §3.12
    [FilingStatus.HeadOfHousehold]: 63000,           // Rev. Proc. 2023-34 §3.12
    [FilingStatus.QualifyingSurvivingSpouse]: 94050, // Rev. Proc. 2023-34 §3.12
  } as Record<FilingStatus, number>,
  // 15% rate upper thresholds — Rev. Proc. 2023-34 §3.12, Table 3
  THRESHOLD_15: {
    [FilingStatus.Single]: 518900,                   // Rev. Proc. 2023-34 §3.12
    [FilingStatus.MarriedFilingJointly]: 583750,     // Rev. Proc. 2023-34 §3.12
    [FilingStatus.MarriedFilingSeparately]: 291850,  // Rev. Proc. 2023-34 §3.12 (½ of MFJ $583,750)
    [FilingStatus.HeadOfHousehold]: 551350,          // Rev. Proc. 2023-34 §3.12
    [FilingStatus.QualifyingSurvivingSpouse]: 583750, // Rev. Proc. 2023-34 §3.12
  } as Record<FilingStatus, number>,
};
...
export const QCD = {
  MAX_AMOUNT: 105000,             // IRC §408(d)(8)(B) — per-person annual limit (2024, first indexed year)
...
// Constants: Rev. Proc. 2023-34, Section 3.06 — AGI thresholds
// ──────────────────────────────────────────────────
...
export const SAVERS_CREDIT = {
  ...
  // AGI thresholds — Rev. Proc. 2023-34 §3.06
  // Single / MFS
  SINGLE_50: 23000,                  // Rev. Proc. 2023-34, §25B(b)(1)(A) — 50% rate
  SINGLE_20: 25000,                  // Rev. Proc. 2023-34, §25B(b)(1)(B) — 20% rate
  SINGLE_10: 38250,                  // Rev. Proc. 2023-34, §25B(b)(1)(C)/(D) — 10% rate
  // Head of Household
  HOH_50: 34500,                     // Rev. Proc. 2023-34, §25B(b)(1)(A) — 50% rate
  HOH_20: 37500,                     // Rev. Proc. 2023-34, §25B(b)(1)(B) — 20% rate
  HOH_10: 57375,                     // Rev. Proc. 2023-34, §25B(b)(1)(C)/(D) — 10% rate
  // MFJ / QSS
  MFJ_50: 46000,                     // Rev. Proc. 2023-34, §25B(b)(1)(A) — 50% rate
  MFJ_20: 50000,                     // Rev. Proc. 2023-34, §25B(b)(1)(B) — 20% rate
  MFJ_10: 76500,                     // Rev. Proc. 2023-34, §25B(b)(1)(C)/(D) — 10% rate
};
...
// Constants: Rev. Proc. 2023-34, Section 3.19 — Educator expense limit
// ──────────────────────────────────────────────────

export const EDUCATOR_EXPENSES = {
  MAX_DEDUCTION: 300,               // Rev. Proc. 2023-34 §3.19 — $300 per educator
};
...
// Last updated: 2024 (current OFAC designations)
// ──────────────────────────────────────────────────
...
// Constants: SSA COLA announcement, Oct 2023 — SS wage base for 2024
// ──────────────────────────────────────────────────

export const EXCESS_SS_TAX = {
  SS_TAX_RATE: 0.062,                     // IRC §3101(a) — 6.2% employee SS rate
  SS_WAGE_BASE: 168600,                    // SSA announcement — 2024 SS wage base
  MAX_SS_TAX: 10453.20,                    // 6.2% × $168,600 = $10,453.20
};
...
// ──────────────────────────────────────────────────
// Estimated Tax Penalty (Form 2210) — 2024
// Authority: IRC §6654 — Failure to pay estimated income tax
//           IRC §6621(a)(2) — Underpayment rate
// Constants: IRS underpayment rate announcement for 2024
// ──────────────────────────────────────────────────

export const ESTIMATED_TAX_PENALTY = {
  RATE: 0.08,                           // IRC §6621(a)(2) — 8% annual rate (Q1-Q4 2024)
  ...
  //   Q1: Apr 15, 2024 → Apr 15, 2025 = 365 days
  //   Q2: Jun 17, 2024 → Apr 15, 2025 = 303 days (Jun 15 falls on Sunday)
  //   Q3: Sep 16, 2024 → Apr 15, 2025 = 212 days (Sep 15 falls on Sunday)
  //   Q4: Jan 15, 2025 → Apr 15, 2025 = 90 days
  //
  ...
  //
  // For TY2024, all four rate periods use 8% (federal short-term rate 5% + 3%).
  ...
  DAYS_MATRIX: [
    ...
    [14, 92, 92, 104],  // Q2: Jun 17→Jun 30(14d), Jul 1→Sep 30(92d), Oct 1→Dec 31(92d), Jan 1→Apr 15(104d) = 303
    [0,  15, 92, 104],  // Q3: Sep 16→Sep 30(15d), Oct 1→Dec 31(92d), Jan 1→Apr 15(104d) = 212
    [0,   0,  0,  90],  // Q4: Jan 15→Apr 15(90d)
  ] as readonly (readonly number[])[],
  // Annual underpayment rate for each rate period (IRC §6621(a)(2))
  // TY2024: all periods = 8% (federal short-term rate rounded up + 3%)
  PERIOD_RATES: [0.08, 0.08, 0.08, 0.08] as readonly number[],
};

// ──────────────────────────────────────────────────
// Kiddie Tax (Form 8615) — 2024
// Authority: IRC §1(g) — Certain unearned income of children taxed at parent's rate
// Constants: Rev. Proc. 2023-34, Section 3.03 — Kiddie tax thresholds
// ──────────────────────────────────────────────────
...
// ──────────────────────────────────────────────────
// Foreign Earned Income Exclusion (Form 2555) — 2024
// Authority: IRC §911 — Citizens or residents living abroad
// Constants: Rev. Proc. 2023-34, Section 3.36 — FEIE exclusion amount
// ──────────────────────────────────────────────────

export const FEIE = {
  EXCLUSION_AMOUNT: 126500,             // Rev. Proc. 2023-34 §3.36 — $126,500 max exclusion
  HOUSING_BASE: 19734,                  // IRC §911(c)(1)(B) — 16% of exclusion ($126.5k × 0.156)
  HOUSING_MAX_EXCLUSION: 37950,         // IRC §911(c)(2)(A) — 30% of exclusion ($126.5k × 0.30)
};

// ──────────────────────────────────────────────────
// Schedule H — Household Employee Tax (2024)
...
export const SCHEDULE_H = {
  CASH_WAGE_THRESHOLD: 2700,            // IRC §3121(x), SSA 2024 — SS/Medicare threshold
...
// ──────────────────────────────────────────────────
// Adoption Credit (Form 8839) — 2024
// Authority: IRC §23 — Adoption expenses credit
// Constants: Rev. Proc. 2023-34, Section 3.35 — Adoption credit limits
// ──────────────────────────────────────────────────

export const ADOPTION_CREDIT = {
  MAX_CREDIT: 16810,                    // Rev. Proc. 2023-34 §3.35 — Max per child
  PHASE_OUT_START: 252150,              // Rev. Proc. 2023-34 §3.35 — AGI phase-out start
...
// ──────────────────────────────────────────────────
// Premium Tax Credit (Form 8962) — 2024
...
// Constants: HHS 2023 Federal Poverty Guidelines (used for TY2024)
//           Rev. Proc. 2023-34 — Applicable figure table
// ──────────────────────────────────────────────────

export const PREMIUM_TAX_CREDIT = {
  // Federal Poverty Level — HHS 2023 guidelines (88 FR 4824), used for TY2024
  // 48 contiguous states + DC
  FPL_BASE_48: 14580,                         // HHS 2023 FPL — Family size 1 (48 states + DC)
  ...
  // Excess APTC Repayment Caps — Rev. Proc. 2023-34, Table 5; IRC §36B(f)(2)(B)
  REPAYMENT_CAPS: [
    { floor: 0, ceiling: 200, singleCap: 350, otherCap: 700 },     // Rev. Proc. 2023-34 Table 5
    { floor: 200, ceiling: 300, singleCap: 875, otherCap: 1750 },   // Rev. Proc. 2023-34 Table 5
    { floor: 300, ceiling: 400, singleCap: 1500, otherCap: 3000 },  // Rev. Proc. 2023-34 Table 5
...
// Note: Does NOT exist for 2024 (OBBBA starts 2025). All values set to 0 / N/A.
// ──────────────────────────────────────────────────

export const SCHEDULE_1A = {
  // No Tax on Tips — N/A for 2024
  TIPS_CAP: 0,
  TIPS_PHASE_OUT_SINGLE: 0,
  TIPS_PHASE_OUT_MFJ: 0,
  TIPS_PHASE_OUT_RATE: 0,
  TIPS_PHASE_OUT_STEP: 0,

  // No Tax on Overtime — N/A for 2024
  OVERTIME_CAP_SINGLE: 0,
  OVERTIME_CAP_MFJ: 0,
  OVERTIME_PHASE_OUT_SINGLE: 0,
  OVERTIME_PHASE_OUT_MFJ: 0,
  OVERTIME_PHASE_OUT_RATE: 0,
  OVERTIME_PHASE_OUT_STEP: 0,

  // No Tax on Car Loan Interest — N/A for 2024
  CAR_LOAN_CAP: 0,
  CAR_LOAN_PHASE_OUT_SINGLE: 0,
  CAR_LOAN_PHASE_OUT_MFJ: 0,
  CAR_LOAN_PHASE_OUT_RATE: 0,
  CAR_LOAN_PHASE_OUT_STEP: 0,

  // Enhanced Senior Deduction — N/A for 2024
  SENIOR_AMOUNT: 0,
  SENIOR_PHASE_OUT_SINGLE: 0,
  SENIOR_PHASE_OUT_MFJ: 0,
  SENIOR_PHASE_OUT_RATE: 0,
};
...
// Constants: SSA announcement — SS wage base for 2024
// ──────────────────────────────────────────────────
...
export const FORM_4137 = {
  ...
  SS_WAGE_BASE: 168600,                   // SSA announcement — 2024 Social Security wage base
};
...
// ──────────────────────────────────────────────────
// Schedule R — Credit for the Elderly or the Disabled (2024)
...
// ──────────────────────────────────────────────────
// Solo 401(k) — Defined Contribution Limits (2024)
...
// Constants: IRS Notice 2023-75 — 2024 retirement plan limits
// ──────────────────────────────────────────────────
...
export const SOLO_401K = {
  ...
  ANNUAL_ADDITION_LIMIT: 69000,             // IRC §415(c)(1)(A) — 2024 total annual additions limit
  COMPENSATION_CAP: 345000,                 // IRC §401(a)(17) — 2024 compensation cap for calculations
};
...
export const SEP_IRA = {
  ...
  MAX_CONTRIBUTION: 69000,                  // IRC §402(h)(2) — 2024 max SEP-IRA contribution ($69,000)
  COMPENSATION_CAP: 345000,                 // IRC §401(a)(17) — 2024 compensation cap
};

// ──────────────────────────────────────────────────
// SIMPLE IRA Contribution Limits (2024)
// Authority: IRC §408(p)(2)(A) — Elective deferral limit for SIMPLE plans
//           IRC §414(v)(2)(B)(ii) — SIMPLE catch-up ($3,500 for 2024)
//           IRC §414(v)(2)(E) — SECURE 2.0 super catch-up ($5,250 for ages 60-63)
// Constants: IRS Notice 2023-75 — 2024 retirement plan limits
// ──────────────────────────────────────────────────

export const SIMPLE_IRA = {
  EMPLOYEE_DEFERRAL_LIMIT: 16000,          // IRC §408(p)(2)(A)(ii) — 2024 SIMPLE elective deferral limit
  CATCH_UP_50_PLUS: 3500,                  // IRC §414(v)(2)(B)(ii) — Age 50+ catch-up for SIMPLE ($3,500 for 2024)
  SUPER_CATCH_UP_60_63: 5250,             // IRC §414(v)(2)(E) — Ages 60-63 super catch-up (SECURE 2.0, $5,250 for 2024)
...
// Authority: Rev. Proc. 2023-34 (2024 inflation-adjusted amounts)
...
export const PLAUSIBILITY = {
  ...
  SALT_ENTERED_HIGH: 50_000,              // Total SALT entered > $50K (cap is $10K for 2024)
