...
export async function generateForm1040PDF(
  ...
  page.drawText(`Tax Year ${taxReturn.taxYear}  |Prepared by HATax`, {
    x: MARGIN_L,
    y: cursor.y,
    size: 8,
    font: italic,
  ...
  cursor.y -= 10;
  page.drawText(
    'Consult a qualified tax professional before filing. Generated by HATax.',
    { x: MARGIN_L, y: cursor.y, size: 7, font: italic, color: LIGHT_GRAY },
  );
...
export async function generateScheduleDPDF(
  ...
  cursor.y -= 12;
  page.drawText(
    'This document is for informational purposes only. Generated by HATax.',
    { x: MARGIN_L, y: cursor.y, size: 7, font: italic, color: LIGHT_GRAY },
  );
...
export async function generateStateTaxSummaryPDF(
  ...
  page.drawText(`${sr.stateCode}  |  ${residencyLabel}  |  Prepared by HATax`, {
    x: MARGIN_L,
    y: cursor.y,
    size: 8,
    font: italic,
